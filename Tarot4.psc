...
// -------------------------
// Función para validar nombre o apellido (solo letras y espacios)
// -------------------------
...
SiNo
	...
	Para i<-1 Hasta Longitud(txt) Hacer
		Si ( (Subcadena(txt,i,i)<"A" O Subcadena(txt,i,i)>"Z") Y (Subcadena(txt,i,i)<"a" O Subcadena(txt,i,i)>"z") Y (Subcadena(txt,i,i)<>" ") ) Entonces
			valido <- Falso
		FinSi
	FinPara
FinSi
...
Proceso TarotInteractivo
    ...
    Escribir "[1m[36mEscribe tu nombre y apellido para una lectura personalizada (o SALIR en nombre para terminar):"
    
    Mientras resultado = 0 Hacer
        // Leer nombre
        Escribir "[1m[36mIngresa tu nombre:"
        Leer nombre
        resultado <- ProcesarComando(Mayúsculas(nombre))
        ...
        Si resultado = 0 Entonces
            ...
            SiNo
                ...
                Leer apellido
                resultado <- ProcesarComando(Mayúsculas(apellido))
                ...
                Si resultado = 0 Entonces
                    ...
                    SiNo
                        ...
                        // Selección de cartas 
                        carta1 <- Aleatorio(1,22)   // Primera carta
                        Repetir
